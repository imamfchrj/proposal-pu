...
class Komponen_sub_mst_model extends CI_Model {

    private $table = "tb_master_sub_komponen";
    ...
    function get_by_id_with_field($id, $field){
        $result = $this->get_by_key($id);
        if(!$result) {
            return "";
        }
        return $result->$field;
