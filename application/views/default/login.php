...
<div class="signin-wrapper">
    ...
    <div class="signin-box">
        ...
        <h2 class="signin-title-primary">Silahkan login</h2>
        <!--        <h3 class="signin-title-secondary"></h3>-->

        <div class="form-group">
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="icon ion-person tx-16 lh-0 op-4"></i></span>
                </div>
        ...
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="icon ion-locked tx-16 lh-0 op-4"></i></span>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                ...
                <button type="button" class="btn btn-danger pd-x-25 link_failed" data-dismiss="modal"
